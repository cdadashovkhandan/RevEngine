...
Wireframe::Wireframe(QOpenGLFunctions_4_1_Core * gl) : Material(gl) {
    shader = new QOpenGLShaderProgram();
    shader->addShaderFromSourceFile(QOpenGLShader::Vertex, ":/shaders/phong.vert");
    shader->addShaderFromSourceFile(QOpenGLShader::Fragment, ":/shaders/wireframe.frag");
    shader->link();
}
...
void Wireframe::update_uniforms(QMatrix4x4 model_mat, QMatrix4x4 view_mat, QMatrix4x4 proj_mat, QMatrix3x3 normal_mat) {
    bind();

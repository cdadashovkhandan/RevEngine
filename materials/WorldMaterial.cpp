...
WorldMaterial::WorldMaterial(QOpenGLFunctions_4_1_Core* gl) : Material(gl)
{
    shader = new QOpenGLShaderProgram();
    shader->addShaderFromSourceFile(QOpenGLShader::Vertex, ":/shaders/world.vert");
    shader->addShaderFromSourceFile(QOpenGLShader::Geometry, ":/shaders/world.geom");
    shader->addShaderFromSourceFile(QOpenGLShader::Fragment, ":/shaders/world.frag");
    shader->link();
}

void WorldMaterial::update_uniforms(QMatrix4x4 model_mat, QMatrix4x4 view_mat, QMatrix4x4 proj_mat, QMatrix3x3 normal_mat) {
    bind();
